...
public class SeventhChoice
{
    String seventh(String choice, int b, int a, int d, int da, int m, int cs, int t, int mb, int ma, int md, int mda, int mm, int mcs, int mt, int bA, int aA, int dA, int daA, int mA, int csA, int tA)
    {
